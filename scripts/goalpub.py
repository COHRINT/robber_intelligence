...
def goalPub():
    ...
    navGoalPub = rospy.Publisher('roy/move_base/goal', mov_msgs.MoveBaseGoal, queue_size=10) # could be /move_base/current_goal
    rate = rospy.Rate(10)
    ...
    # FUCK STEVE, HE KNEW FROM THE BEGINNING, WHAT IS THE COORDINATE SYSTEM?
